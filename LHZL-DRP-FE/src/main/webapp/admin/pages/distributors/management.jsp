...
<div class="wrapper">
    ...
    <div class="content-wrapper" id="pjax-content">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="codeFormLabel">分销商</h4>
                    </div>
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="form-group">
                                <label>分销商名称</label>
                                <input type="text" name="username" class="form-control" placeholder="分销商名称">
                            </div>
                            <div class="form-group">
                                <label>电话</label>
        ...
        <script> initDataOperAndUser();</script>
    </div>
